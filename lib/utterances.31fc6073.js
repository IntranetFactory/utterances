...
},{"./deparam":49,"./repo-regex":74}],76:[function(require,module,exports) {
"use strict";
...
exports.login = login;
},{"./deparam":49,"./page-attributes":56}],78:[function(require,module,exports) {
"use strict";
...
},{"./oauth":76,"./encoding":78,"./page-attributes":56}],62:[function(require,module,exports) {
"use strict";
...
},{"./bus":62}],92:[function(require,module,exports) {
"use strict";
...
},{"./time-ago":92}],89:[function(require,module,exports) {
"use strict";
...
},{"./comment-component":91,"./bus":62}],90:[function(require,module,exports) {
"use strict";
...
},{"./github":58,"./bus":62}],82:[function(require,module,exports) {
"use strict";
    ...
    function IssueComponent(issue, user) {
        ...
        var submit = function submit(markdown) {
            ...
            return oauth_1.login().then(function () {
                ...
                _this.element.dispatchEvent(new CustomEvent('user-changed', { detail: user, bubbles: true }));
            });
        };
...
},{"./page-attributes":56,"./bus":62,"./github":58,"./oauth":76,"./timeline-component":89,"./new-comment-component":90}],60:[function(require,module,exports) {
"use strict";
        ...
        var newIssueSubmit = function newIssueSubmit(title, description) {
            if (_this._user) {
                ...
                return commentPromise.then(function () {
                    ...
                    github_1.loadIssuesByType(page_attributes_1.pageAttributes.issueTerm, "open").then(function (issues) {
                        setIssuesFn(issues);
                    });
                });
            }
...
},{"./page-attributes":56,"./oauth":76,"./bus":62,"./github":58,"./new-issue-component":80,"./issue-component":82}],43:[function(require,module,exports) {
"use strict";
...
},{"./page-attributes":56,"./github":58,"./feedback-component":60,"./bus":62}]},{},[43])
//# sourceMappingURL=utterances.31fc6073.map