...
var uc = window.utterancesConfig;
var apiUrl = uc && uc.hasOwnProperty('utterancesApi') ? uc['utterancesApi'] : 'http://localhost:5000';
var UTTERANCES_API = apiUrl;

var authorizeUrl = UTTERANCES_API + "/authorize";
var tokenUrl = UTTERANCES_API + "/token";
