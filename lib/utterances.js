...
var authorizeUrl = pageAttributes.utterancesApi + "/authorize";
var tokenUrl = pageAttributes.utterancesApi + "/token";
...
function createIssue(issueTerm, documentUrl, title, description) {
    var request = new Request(pageAttributes.utterancesApi + "/repos/" + owner + "/" + repo + "/issues", {
        method: 'POST',
        body: JSON.stringify({
            title: issueTerm,
