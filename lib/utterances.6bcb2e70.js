...
},{"./deparam":49,"./repo-regex":65}],67:[function(require,module,exports) {
"use strict";
...
exports.login = login;
},{"./deparam":49,"./page-attributes":53}],73:[function(require,module,exports) {
"use strict";
...
},{"./oauth":67,"./encoding":73,"./page-attributes":53}],83:[function(require,module,exports) {
"use strict";
...
},{"./page-attributes":53,"./github":55,"./oauth":67,"./timeline-component":69,"./new-comment-component":71,"./bus":59}],43:[function(require,module,exports) {
"use strict";
...
function loadIssues() {
    return github_1.loadIssuesByType("open");
}
Promise.all([loadIssues(), github_1.loadUser()]).then(function (_a) {
    var issues = _a[0],
        user = _a[1];
    return bootstrap(issues, user);
});
function bootstrap(issues, user) {
    bus_1.setHostOrigin(page_attributes_1.pageAttributes.origin);
    if (!issues) return;
    var tabChanged = function tabChanged(tabname) {
        if (!tabname) return;
    ...
    var feedback = new feedback_component_1.FeedbackComponent(tabChanged, user);
    feedback.setIssues(issues);
...
//# sourceMappingURL=utterances.6bcb2e70.map